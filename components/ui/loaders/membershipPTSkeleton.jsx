...
const MembershipPTSkeleton = ({ priority = "medium" }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Search Bar with Month Picker Skeleton */}
      <View style={styles.searchContainer}>
        ...
        <SkeletonBox style={styles.monthPicker} pulse={priority !== "low"} />
      </View>

      {/* Client Cards Skeleton */}
      <View style={styles.clientsContainer}>
        {/* Monthly Stats Cards Skeleton - Inside content */}
          ...
          <View key={item} style={styles.clientCard}>
            ...
            <View style={styles.clientInfo}>
              ...
              <View style={styles.clientDetails}>
                ...
                <SkeletonBox style={styles.detailIcon} pulse={false} />
                <SkeletonBox style={styles.detailText2} pulse={false} />
              </View>
            </View>

            <View style={styles.rightSection}>
              <SkeletonBox style={styles.planBadge} pulse={false} />
              <SkeletonBox
...
export default MembershipPTSkeleton;
