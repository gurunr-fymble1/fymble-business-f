...
const BookingsPage = () => {
  ...
  const cardsData = [
    {
      title: "Daily Pass & Class Bookings",
      subtitle: "View all Daily pass and Fitness\nClass bookings from clients",
      imagePath: require("../../../assets/images/bookings/daily_pass.png"),
      onPress: () => router.push("/owner/(sessions)/sessionBookings"),
      buttonText: "View",
      charWidth: 120,
      charHeight: 120,
    },
    {
      title: "Membership & PT Bookings",
      subtitle: "View and manage membership\nand PT plan bookings from clients",
      imagePath: require("../../../assets/images/bookings/membership.png"),
